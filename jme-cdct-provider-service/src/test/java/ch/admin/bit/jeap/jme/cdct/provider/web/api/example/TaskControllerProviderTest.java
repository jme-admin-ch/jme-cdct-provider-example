package ch.admin.bit.jeap.jme.cdct.provider.web.api.example;
...
import ch.admin.bit.jeap.jme.cdct.provider.web.api.task.Task;
...
@SpringBootTest(
    ...
    properties = {
        ...
        "jeap.security.oauth2.resourceserver.authorization-server.jwk-set-uri=http://localhost:1235/jme-cdct-provider-service/.well-known/jwks.json"
    }
)
@Import(JeapOAuth2IntegrationTestResourceConfiguration.class)
@Provider("bit-jme-cdct-provider-service")
@PactBroker
@AllowOverridePactUrl // Allow externally specified pact url to override other consumer version selectors. Needed for the automated contract verification.
...
class TaskControllerProviderTest {
    ...
    void setUp(PactVerificationContext context) {
        ...
        if (context != null) {
            context.setTarget(new HttpTestTarget("localhost", 1235, "/jme-cdct-provider-service"));
